$(document).ready(function () {
    ...
    function damage_calc() {
        ...
        document.getElementById("increase_damage").value = total_id;
        document.getElementById("total_damage").value = total_dmg;
        document.getElementById("weapon_mn").value = weapon_min_dmg;
        document.getElementById("weapon_mx").value = weapon_max_dmg;
